...
Facebook's scheduler-free optimizer: https://github.com/facebookresearch/schedule_free/
"""
...
from accelerate.utils import is_schedulefree_available, set_seed
...
def main():
    ...
    # )
    student_model, teacher_model, optimizer = accelerator.prepare(
