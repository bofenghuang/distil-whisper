...
class DataCollatorSpeechSeq2SeqWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], np.ndarray]]]) -> Dict[str, np.ndarray]:
        ...
        batch = self.processor.feature_extractor.pad(
            ...
            # pad_to_multiple_of=self.pad_to_multiple_of,  # ~~128 doesn't need to pad but perhaps useful for 80 (v1/v2)~~, actually cannot pad
            return_tensors="pt",
        )
...
def main():
    ...
    # )
    student_model, teacher_model, optimizer, lr_scheduler, train_dataloader, *validation_dataloaders = accelerator.prepare(
        student_model, teacher_model, optimizer, lr_scheduler, train_dataloader, *validation_dataloaders
    )
        ...
        for batch in train_dataloader:
            ...
            if accelerator.sync_gradients:
                ...
                if training_args.do_eval and (cur_step % eval_steps == 0 or cur_step == total_train_steps):
                    ...
                    student_model.eval()
                    # ======================== Evaluating ==============================
                    for eval_id, eval_split in enumerate(all_eval_splits):
                        eval_metrics = []
                        eval_preds = []
                        eval_labels = []
                        ...
                        validation_dataloader = validation_dataloaders[eval_id]
                        ...
                        for batch in tqdm(
                            ...
                            if training_args.predict_with_generate:
                                ...
                                # )
                                generated_ids, labels = generate_step(batch)
